...
export const GUEST_LIST: GuestEntry[] = [
  ...
  { keys: ["alfonsomurcia"], displayNames: ["Murcia"] },
  ...
  { keys: ["valentinahoyos"], displayNames: ["Valen"] },
  { keys: ["valentinagrisales"], displayNames: ["Valentina"] },
  ...
  { keys: ["familiamesanieto"], displayNames: ["Familia Mesa Nieto"] },
  ...
  { keys: ["gerson"], displayNames: ["Gerson"] },
  ...
  { keys: ["lina"], displayNames: ["Lina"] },
  { keys: ["saddy"], displayNames: ["Andrés", "Saddy"] }
